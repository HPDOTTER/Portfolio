...
export class TranslationService {
    ...
    private translations: { [lang: string]: Translation } = {
        en: {
            ...
            'legal.termsText':
                'By accessing and using <a class="link" href="/">Portfolio</a> (Product), you acknowledge and agree to the following terms and conditions, and any policies, guidelines, or amendments thereto that may be presented to you from time to time. We, the listed students, may update or change the terms and conditions from time to time without notice.',
            'legal.ownership': 'Scope and ownership of the product',
            'legal.ownershipText':
                '<a class="link" href="/">Portfolio</a> has been developed as part of a student project in a web development bootcamp at the <a class="link" href="https://developerakademie.com/">Developer Akademie GmbH</a>. It has an educational purpose and is not intended for extensive personal & business usage. As such, we cannot guarantee consistent availability, reliability, accuracy, or any other aspect of quality regarding this Product. The design of <a class="link" href="/">Portfolio</a> is owned by the <a class="link" href="https://developerakademie.com/">Developer Akademie GmbH</a>. Unauthorized use, reproduction, modification, distribution, or replication of the design is strictly prohibited.',
            'legal.rights': 'Proprietary rights',
            'legal.rightsText':
                'Aside from the design owned by <a class="link" href="https://developerakademie.com/">Developer Akademie GmbH</a>, we, the listed students, retain all proprietary rights in <a class="link" href="/">Portfolio</a>, including any associated copyrighted material, trademarks, and other proprietary information.',
            'legal.productuse': 'Use of the product',
            'legal.productuseText':
                '<a class="link" href="/">Portfolio</a> is intended to be used for lawful purposes only, in accordance with all applicable laws and regulations. Any use of <a class="link" href="/">Portfolio</a> for illegal activities, or to harass, harm, threaten, or intimidate another person, is strictly prohibited. You are solely responsible for your interactions with other users of <a class="link" href="/">Portfolio</a>.',
            'legal.disclaimer':
                'Disclaimer of warranties and limitation of liability',
            'legal.disclaimerText':
                '<a class="link" href="/">Portfolio</a> is provided "as is" without warranty of any kind, whether express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, and non-infringement. In no event will we, the listed students, or the <a class="link" href="https://developerakademie.com/">Developer Akademie GmbH</a>, be liable for any direct, indirect, incidental, special, consequential or exemplary damages, including but not limited to, damages for loss of profits, goodwill, use, data, or other intangible losses, even if we have been advised of the possibility of such damages, arising out of or in connection with the use or performance of <a class="link" href="/">Portfolio</a>.',
            'legal.indemnification': 'Indemnity',
            'legal.indemnificationText':
                'You agree to indemnify, defend and hold harmless us, the listed students, the <a class="link" href="https://developerakademie.com/">Developer Akademie GmbH</a>, and our affiliates, partners, officers, directors, agents, and employees, from and against any claim, demand, loss, damage, cost, or liability (including reasonable legal fees) arising out of or relating to your use of <a class="link" href="/">Portfolio</a> and/or your breach of this Legal Notice.',
